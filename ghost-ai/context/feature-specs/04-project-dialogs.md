...
Build the '/editor' home and add projector dialogs/sidebar actions. No API calls or persistance yet.
...
- no input
- confirm button uses destrucive styling
